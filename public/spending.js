...
function showTransactions() {
  ...
  for (var reason in weekreasons) { //loop through the reasons for this week
    ...
    week_byreason.innerHTML += "<div class=\"w3-panel w3-blue\" style=\"margin: 5px;\"><p style=\"padding:5px;\">"+reason + ": £" + amount.toFixed(2)+"</p></div>"; //add html
  }
  for (var x in weekdaylist) { //loop through days in a week
    ...
    week_byday.innerHTML += "<div class=\"w3-panel w3-blue\" style=\"margin: 5px;\"><p style=\"padding:5px;\">"+day + ": £" + amount.toFixed(2)+"</p></div>"; //add html
  }
}
